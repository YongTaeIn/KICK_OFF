...
url = "http://203.250.148.120:20519/Mobius/kick_off/map/speed_bump/image"
...
url_3 = "http://203.250.148.120:20519/Mobius/kick_off/map/speed_bump/gps"
...
def send_gps(data):    
    #url_3 = "http://203.250.148.120:20519/Mobius/kick/buff_data"
    payload = "{\n    \"m2m:cin\": {\n        \"con\": \"%s\"\n    }\n}" %(data)
    headers = {
    'Accept': 'application/json',
    'X-M2M-RI': '12345',
...
while True:
    ...
    os.system( 'python ../detect.py --source ../inference/images/test.jpg --weights ../runs/train/exp/weights/best.pt --conf 0.4 ')
